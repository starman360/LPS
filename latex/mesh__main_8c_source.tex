\hypertarget{mesh__main_8c_source}{}\doxysection{mesh\+\_\+main.\+c}
\label{mesh__main_8c_source}\index{main/mesh\_main.c@{main/mesh\_main.c}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001 }
\DoxyCodeLine{00002 \textcolor{comment}{/* }}
\DoxyCodeLine{00003 \textcolor{comment}{Mesh Main}}
\DoxyCodeLine{00004 \textcolor{comment}{Anmol Modur}}
\DoxyCodeLine{00005 \textcolor{comment}{3/15/19}}
\DoxyCodeLine{00006 \textcolor{comment}{*/}}
\DoxyCodeLine{00007 }
\DoxyCodeLine{00008 \textcolor{comment}{/* -\/-\/-\/ Include Libraries -\/-\/-\/ */}}
\DoxyCodeLine{00009 \textcolor{preprocessor}{\#include <string.h>}}
\DoxyCodeLine{00010 \textcolor{comment}{// Mesh Libraries}}
\DoxyCodeLine{00011 \textcolor{preprocessor}{\#include "esp\_wifi.h"}}
\DoxyCodeLine{00012 \textcolor{preprocessor}{\#include "esp\_system.h"}}
\DoxyCodeLine{00013 \textcolor{preprocessor}{\#include "esp\_event\_loop.h"}}
\DoxyCodeLine{00014 \textcolor{preprocessor}{\#include "esp\_log.h"}}
\DoxyCodeLine{00015 \textcolor{preprocessor}{\#include "esp\_mesh.h"}}
\DoxyCodeLine{00016 \textcolor{preprocessor}{\#include "esp\_mesh\_internal.h"}}
\DoxyCodeLine{00017 \textcolor{comment}{// \#include "mesh\_light.h"}}
\DoxyCodeLine{00018 \textcolor{preprocessor}{\#include "nvs\_flash.h"}}
\DoxyCodeLine{00019 \textcolor{comment}{// Decawave Libraries}}
\DoxyCodeLine{00020 \textcolor{preprocessor}{\#include "dwm1001.h"}}
\DoxyCodeLine{00021 \textcolor{preprocessor}{\#include "esp\_nvs.h"}}
\DoxyCodeLine{00022 \textcolor{preprocessor}{\#include "esp\_interrupt.h"}}
\DoxyCodeLine{00023 \textcolor{preprocessor}{\#include "triangulation.h"}}
\DoxyCodeLine{00024 \textcolor{comment}{// Lwip Libraries}}
\DoxyCodeLine{00025 \textcolor{preprocessor}{\#include "lwip/err.h"}}
\DoxyCodeLine{00026 \textcolor{preprocessor}{\#include "lwip/sockets.h"}}
\DoxyCodeLine{00027 \textcolor{preprocessor}{\#include "lwip/sys.h"}}
\DoxyCodeLine{00028 \textcolor{preprocessor}{\#include "lwip/netdb.h"}}
\DoxyCodeLine{00029 \textcolor{preprocessor}{\#include "lwip/dns.h"}}
\DoxyCodeLine{00030 }
\DoxyCodeLine{00031 \textcolor{preprocessor}{\#include "driver/gpio.h"}}
\DoxyCodeLine{00032 \textcolor{preprocessor}{\#include "driver/i2c.h"}}
\DoxyCodeLine{00033 \textcolor{preprocessor}{\#include "ssd1366.h"}}
\DoxyCodeLine{00034 \textcolor{preprocessor}{\#include "font8x8\_basic.h"}}
\DoxyCodeLine{00035 \textcolor{comment}{/*******************************************************}}
\DoxyCodeLine{00036 \textcolor{comment}{ *                Macros}}
\DoxyCodeLine{00037 \textcolor{comment}{ *******************************************************/}}
\DoxyCodeLine{00038 \textcolor{comment}{//\#define MESH\_P2P\_TOS\_OFF}}
\DoxyCodeLine{00039 }
\DoxyCodeLine{00040 \textcolor{comment}{/*******************************************************}}
\DoxyCodeLine{00041 \textcolor{comment}{ *                Constants}}
\DoxyCodeLine{00042 \textcolor{comment}{ *******************************************************/}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00043}\mbox{\hyperlink{mesh__main_8c_aaa981e599aa044183d4c19a576cdc8a9}{00043}} \textcolor{preprocessor}{\#define RX\_SIZE (1500)}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00044}\mbox{\hyperlink{mesh__main_8c_a6a1eef3a18bfaa9a6c515692ffd9321e}{00044}} \textcolor{preprocessor}{\#define TX\_SIZE (1460)}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00045}\mbox{\hyperlink{mesh__main_8c_a0d28862cf0300f82c05e77ce36fc415f}{00045}} \textcolor{preprocessor}{\#define MESH\_SERVER\_IP "192.168.0.103"}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00046}\mbox{\hyperlink{mesh__main_8c_a18c25eaf6d7220b554300a512776d52f}{00046}} \textcolor{preprocessor}{\#define MESH\_PORT 3000}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00047}\mbox{\hyperlink{mesh__main_8c_a526d580d324bce60a3e964066fae77e3}{00047}} \textcolor{preprocessor}{\#define SDA\_PIN GPIO\_NUM\_21}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00048}\mbox{\hyperlink{mesh__main_8c_a06c967e78bcedcee909a70764f879433}{00048}} \textcolor{preprocessor}{\#define SCL\_PIN GPIO\_NUM\_22}}
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00049}\mbox{\hyperlink{mesh__main_8c_afec25c5f400b1e2ff79878c038385f0d}{00049}} \textcolor{preprocessor}{\#define tag "SSD1306"}}
\DoxyCodeLine{00050 \textcolor{comment}{/*******************************************************}}
\DoxyCodeLine{00051 \textcolor{comment}{ *                Variable Definitions}}
\DoxyCodeLine{00052 \textcolor{comment}{ *******************************************************/}}
\DoxyCodeLine{00053 \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{char} *MESH\_TAG = \textcolor{stringliteral}{"mesh\_main"};}
\DoxyCodeLine{00054 \textcolor{keyword}{static} \textcolor{keyword}{const} uint8\_t MESH\_ID[6] = \{0x77, 0x77, 0x77, 0x77, 0x77, 0x77\};}
\DoxyCodeLine{00055 \textcolor{keyword}{static} uint8\_t tx\_buf[\mbox{\hyperlink{mesh__main_8c_a6a1eef3a18bfaa9a6c515692ffd9321e}{TX\_SIZE}}] = \{}
\DoxyCodeLine{00056     0,}
\DoxyCodeLine{00057 \};}
\DoxyCodeLine{00058 \textcolor{keyword}{static} uint8\_t rx\_buf[\mbox{\hyperlink{mesh__main_8c_aaa981e599aa044183d4c19a576cdc8a9}{RX\_SIZE}}] = \{}
\DoxyCodeLine{00059     0,}
\DoxyCodeLine{00060 \};}
\DoxyCodeLine{00061 \textcolor{keyword}{static} \textcolor{keywordtype}{bool} is\_running = \textcolor{keyword}{true};}
\DoxyCodeLine{00062 \textcolor{keyword}{static} \textcolor{keywordtype}{bool} is\_mesh\_connected = \textcolor{keyword}{false};}
\DoxyCodeLine{00063 \textcolor{keyword}{static} mesh\_addr\_t mesh\_parent\_addr;}
\DoxyCodeLine{00064 \textcolor{keyword}{static} \textcolor{keywordtype}{int} mesh\_layer = -\/1;}
\DoxyCodeLine{00065 \textcolor{keyword}{static} mesh\_addr\_t mesh\_root\_addr;}
\DoxyCodeLine{00066 \textcolor{keyword}{static} dwm\_resp\_tag\_loc\_get loc;}
\DoxyCodeLine{00067 \textcolor{keyword}{static} \textcolor{keywordtype}{bool} gotIP = \textcolor{keyword}{false};}
\DoxyCodeLine{00068 }
...
\DoxyCodeLine{00074 \textcolor{comment}{ *                Function Definitions}}
\DoxyCodeLine{00075 \textcolor{comment}{ *******************************************************/}}
\DoxyCodeLine{00076 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00080}\mbox{\hyperlink{mesh__main_8c_aca395462c6b7e4e924306cfc44a04453}{00080}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_aca395462c6b7e4e924306cfc44a04453}{i2c\_master\_init}}()}
\DoxyCodeLine{00081 \{}
...
\DoxyCodeLine{00091 \}}
\DoxyCodeLine{00092 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00096}\mbox{\hyperlink{mesh__main_8c_ab83a732f28055bd6835d031e13986f0b}{00096}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_ab83a732f28055bd6835d031e13986f0b}{ssd1306\_init}}()}
\DoxyCodeLine{00097 \{}
...
\DoxyCodeLine{00125 \}}
\DoxyCodeLine{00126 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00131}\mbox{\hyperlink{mesh__main_8c_a311b55caa2c35dab8bcf5cdd7e9298fc}{00131}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_a311b55caa2c35dab8bcf5cdd7e9298fc}{task\_ssd1306\_display\_text}}(\textcolor{keyword}{const} \textcolor{keywordtype}{void} *arg\_text)}
\DoxyCodeLine{00132 \{}
...
\DoxyCodeLine{00186 \}}
\DoxyCodeLine{00187 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00191}\mbox{\hyperlink{mesh__main_8c_a8da9870d8488d33189d2cb122bd28e0d}{00191}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_a8da9870d8488d33189d2cb122bd28e0d}{display\_clear}}()}
\DoxyCodeLine{00192 \{}
...
\DoxyCodeLine{00195 \}}
\DoxyCodeLine{00196 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00201}\mbox{\hyperlink{mesh__main_8c_a1ba06564196f4ecea1dbef1324c47648}{00201}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_a1ba06564196f4ecea1dbef1324c47648}{disp\_info}}()}
\DoxyCodeLine{00202 \{}
...
\DoxyCodeLine{00228 \}}
\DoxyCodeLine{00229 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00233}\mbox{\hyperlink{mesh__main_8c_a1059c8afacec7168f7c156914d4e08de}{00233}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_a1059c8afacec7168f7c156914d4e08de}{esp\_mesh\_p2p\_tx\_main}}(\textcolor{keywordtype}{void} *arg)}
\DoxyCodeLine{00234 \{}
...
\DoxyCodeLine{00283 \}}
\DoxyCodeLine{00284 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00289}\mbox{\hyperlink{mesh__main_8c_aa9c0547563005d41e07f1112bf58ac1b}{00289}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_aa9c0547563005d41e07f1112bf58ac1b}{esp\_mesh\_p2p\_rx\_main}}(\textcolor{keywordtype}{void} *arg)}
\DoxyCodeLine{00290 \{}
...
\DoxyCodeLine{00389 \}}
\DoxyCodeLine{00390 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00394}\mbox{\hyperlink{mesh__main_8c_aa9dc638c8ef056dcce3e43536122bd92}{00394}} esp\_err\_t \mbox{\hyperlink{mesh__main_8c_aa9dc638c8ef056dcce3e43536122bd92}{esp\_mesh\_comm\_p2p\_start}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{00395 \{}
...
\DoxyCodeLine{00404 \}}
\DoxyCodeLine{00405 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00410}\mbox{\hyperlink{mesh__main_8c_ae3d8004545b77b5f40579f65bf3f542f}{00410}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_ae3d8004545b77b5f40579f65bf3f542f}{mesh\_event\_handler}}(mesh\_event\_t event)}
\DoxyCodeLine{00411 \{}
...
\DoxyCodeLine{00570 \}}
\DoxyCodeLine{00571 }
\DoxyCodeLine{\Hypertarget{mesh__main_8c_source_l00575}\mbox{\hyperlink{mesh__main_8c_a630544a7f0a2cc40d8a7fefab7e2fe70}{00575}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mesh__main_8c_a630544a7f0a2cc40d8a7fefab7e2fe70}{app\_main}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{00576 \{}
\DoxyCodeLine{00577 }
